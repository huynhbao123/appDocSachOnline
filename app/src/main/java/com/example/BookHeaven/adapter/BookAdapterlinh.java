...
public class BookAdapterlinh extends RecyclerView.Adapter<BookAdapterlinh.BookViewHolder> {
    ...
    public BookAdapterlinh(List<com.example.BookHeaven.models.Booklinh> booklinhs, boolean isFeatured) {
        this.booklinhs = booklinhs;
        this.isFeatured = isFeatured;
    }

    public void updateBooks(List<com.example.BookHeaven.models.Booklinh> newBooklinhs) {
